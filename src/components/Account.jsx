...
function Account() {
  ...
  const { createAt, time, point, logout, nickname, eventName, schoolName } =
    useContext(AuthContext);

  const formattedDate = new Date(createAt).toLocaleString("vi-VN", {
    day: "2-digit",
    month: "2-digit",
    year: "numeric",
    hour: "2-digit",
    ...
    <main className="profile-page">
      <section className="relative block h-500-px">
        <div
          ...
          style={{
            backgroundImage: `url('https://career.fpt.edu.vn/Content/images/logo_unit/fpt-university.png')`,
          }}
        >
          <span
            id="blackOverlay"
              ...
              <div className="flex flex-wrap justify-center">
                <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                  <div className="relative">
                    <img
                      alt="..."
                      src="https://1.bp.blogspot.com/-iRw-u7RGAD4/V4yTYxzxQmI/AAAAAAAAC4E/P_xlNGhPLawFB7LdSfndEMAnxHY9YVA9ACEw/s1600/1468827934.png"
